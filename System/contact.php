...
<head>
	...
	<title>Am3DP Jobs - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Am3DP Jobs" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>Burn street </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:lps@polynnovate.com">lps@polynnovate.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+916375281656">+916375281656</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
										    <h5 class="footer-title">About Am3DP Jobs</h5>
											<p>Am3DP Jobs is a job portal, online job management system developed to find your dream jobs.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Am3DP Contact</h5>
								
								<p>Address : Burn street </p>
								<p>Email : <a href="mailto:lps@polynnovate.com">lps@polynnovate.com</a></p>
								<p>Phone : <a href="tel:+916375281656">+916375281656</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
							 ...
							 <p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> polynnovate.com</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Lokendra Pal Singh</a></li>
								</ul>
